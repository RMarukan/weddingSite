        ...
        <div class="container" style="text-align: center">
            <section class="mt-4">
                <div class="row">
                    ...
                    <p class="col-4 ta-l">
                        <input type="text" name="lstNameK" id="lstNameK" maxlength=10 size="15;" placeholder="姓" value="{{ $all['lstNameK'] }}">
                    </p>
                    <p class="col-4 ta-l">
                        <input type="text" name="fstNameK" id="fstNameK" maxlength=10 size="15;" placeholder="名"value="{{ $all['fstNameK'] }}">
                    </p>
                </div>
                <div class="row">
                    <p class="col-3">お名前<br class="d-lg-none">（かな）</p>
                    <p class="col-4 ta-l">
                        <input type="text" name="lstNameF" id="lstNameF" maxlength=15  size="15;" placeholder="せい" value="{{ $all['lstNameF'] }}">
                    </p>
                    <p class="col-4 ta-l">
                        <input type="text" name="fstNameF" id="fstNameF" maxlength=15  size="15;" placeholder="めい" value="{{ $all['fstNameF'] }}">
                    </p>
                </div>
                <div class="row">
                    <p class="col-3">年代</p>
                ...
                <div class="row">
                    ...
                    <p class="col-9 ta-l">
                        <textarea name="guestComment" cols="35" rows="6" placeholder="">{{ $all['guestComment'] }}</textarea>
                    </p>
                </div>
                <div class="row">
