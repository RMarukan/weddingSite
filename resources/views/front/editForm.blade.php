        ...
        <table class="table table-striped task-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            @else
                                <input type="radio" name="attend1" id="r1" value="yes">
                                <lavel accesskey="Y" for="r1">ご出席</lavel>
                                <input type="radio" name="attend1" id="r2" value="no" checked>
                                <lavel accesskey="N" for="r2">ご欠席</lavel>
                            @endif
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <textarea name="dComment" cols=60 rows=8 placeholder="アレルギー等料理へのご要望がありましたら入力をお願いいたします。">{{ $all['dComment']  }}</textarea>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div>
                            <textarea name="aComment" cols=60 rows=8 placeholder="車椅子のご利用等要望がございましたらご入力をお願いいたします。">{{ $all['aComment']  }}</textarea>
                        </div>
                    </td>
                </tr>
