            ...
            <section class="mt-4 bg-ground">
                <div class="row">
                    ...
                    <p class="col-4 col-sm-4 ta-l">
                        <input type="text" name="lstNameK" id="lstNameK" maxlength=10 size="12;" placeholder="姓" required>
                    </p>
                    <p class="col-4 col-sm-4 ta-l">
                        <input type="text" name="fstNameK" id="fstNameK" maxlength=10 size="12;" placeholder="名" required>
                    </p>
                </div>
                <div class="row">
                    <p class="col-3 col-sm-3"><font color="red">*</font>お名前<br class="d-lg-none">（かな）</p>
                    <p class="col-4 col-sm-4 ta-l">
                        <input type="text" name="lstNameF" id="lstNameF" maxlength=15  size="12;" placeholder="せい" required>
                    </p>
                    <p class="col-4 col-sm-4 ta-l">
                        <input type="text" name="fstNameF" id="fstNameF" maxlength=15  size="12;" placeholder="めい" required>
                    </p>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <p class="col-9 col-sm-9 ta-l">
                        <textarea name="guestComment" cols="30" rows="6" placeholder="" required></textarea>
                    </p>
                </div>
                <div class="row">
                    <p class="col-3 col-sm-3">お料理に対するご要望</p>
                    <p class="col-9 col-sm-9 ta-l">
                        <textarea name="dinnerComment" cols="30" rows="6" placeholder="アレルギー等料理へのご要望がありましたら入力をお願いいたします。"></textarea>
                    </p>
                </div>
                <div class="row">
                    <p class="col-3 col-sm-3">その他<br class="d-lg-none">ご要望</p>
                    <p class="col-9 col-sm-9 ta-l">
                        <textarea name="anotherComment" cols="30" rows="6" placeholder="車椅子のご利用等要望がございましたらご入力をお願いいたします。"></textarea>
                    </p>
                </div>
            </section>
